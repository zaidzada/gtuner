...
function sustainedPlucks(freq, amps, rand) {
  ...
  for (let i = 0; i < total; i += period) {
    ...
    out.set(pluck(freq, 0, amps, n, SAMPLE_RATE, 0.003, rand), i);
  }
  return out;
}
...
export async function generate() {
  ...
  for (const fixture of FIXTURES) {
    ...
    const samples = sustainedPlucks(freq, PROFILES[fixture.profile], rand);
